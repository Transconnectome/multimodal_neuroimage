...
for col in raw_data_smri.columns:
    if 'area' in col:
        area_collist.append(col)
        
new_area_collist = []
for col in area_collist:
    if '._.1' in col:
        new_area_collist.append(col)
    elif '._.2' in col:
        new_area_collist.append(col)
        
new_area_collist = new_area_collist[0:70]
new_area_collist.append('subjectkey')
new_area_collist.remove('lh_WhiteSurfArea_area._.1')
new_area_collist.remove('rh_WhiteSurfArea_area._.2')
...
data2 = pd.merge(raw_data_smri[new_area_collist], raw_data_fmri, how='inner', on='subjectkey')
