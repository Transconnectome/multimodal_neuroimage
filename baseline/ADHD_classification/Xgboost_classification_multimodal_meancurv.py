...
for col in raw_data_smri.columns:
    if 'meancurv' in col:
        meancurv_collist.append(col)
        
new_meancurv_collist = []
for col in meancurv_collist:
    if '._.3' in col:
        new_meancurv_collist.append(col)
    elif '._.4' in col:
        new_meancurv_collist.append(col)
        
new_meancurv_collist.append('subjectkey')
...
data2 = pd.merge(raw_data_smri[new_meancurv_collist], raw_data_fmri, how='inner', on='subjectkey')
