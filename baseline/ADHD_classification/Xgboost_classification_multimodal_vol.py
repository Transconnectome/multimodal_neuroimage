...
for col in raw_data_smri.columns:
    if 'vol' in col:
        vol_collist.append(col)
        
new_vol_collist = []
for col in vol_collist:
    if '._.7' in col:
        new_vol_collist.append(col)
    elif '._.8' in col:
        new_vol_collist.append(col)
        
new_vol_collist.append('subjectkey')
...
data2 = pd.merge(raw_data_smri[new_vol_collist], raw_data_fmri, how='inner', on='subjectkey')
