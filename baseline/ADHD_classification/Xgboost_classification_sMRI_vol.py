...
manufactured_data = pd.merge(valid_sub, raw_data_smri[new_vol_collist], how='inner', on='subjectkey')
...
start_brain_index = np.where(data.columns.values == "lh_bankssts_volume._.7")[0][0]
