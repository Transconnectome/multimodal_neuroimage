...
manufactured_data = pd.merge(valid_sub, raw_data_smri[new_meancurv_collist], how='inner', on='subjectkey')
...
start_brain_index = np.where(data.columns.values == "lh_bankssts_meancurv._.3")[0][0]
